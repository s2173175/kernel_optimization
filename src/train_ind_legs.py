...
from kernel.models.denseNN_ind import DenseNN
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "l2":0,
        "max_epoch":20,
        "data_dir": ["./data/sets/walking_cmd_x.csv", "./data/sets/walking_cmd_y.csv"],
        "batch_size":1000,
        "save_dir": "./kernel/results/walking_ind_nb",
        "log_file": "./kernel/results/walking_ind_nb/training_logs.out",
        "model_file": "./kernel/results/walking_ind_nb/checkpoint_best.pt",
    ...
    parser.add_argument('-batch_size', help='foo help',default=1000, type=int)
    ...
    # model.view_plot_foot_positions() #TODO this needs tp be changed to handle the new data formation
